...
Data.SharedHtml = {
    powerName: function(sectionName, rowIndex){ return '<label>Name <input type="text" id="'+sectionName+ 'Name'+rowIndex+'" onChange="Main.'+sectionName+'Section.getRow('+rowIndex +').changeName();" /></label>\n';},
   powerSkill: function(sectionName, rowIndex){return '<label>Skill <input type="text" id="'+sectionName+'Skill'+rowIndex+'" onChange="Main.'+sectionName+'Section.getRow('+rowIndex+').changeSkill();" /></label>\n';}
};
