...
{
   var queryParameters = {options: [], checkboxes: [], names: []};
   //''.substring(1) === ''
   ...
   //options, checkboxes, names will be [] or a string
   ...
   if ('string' === typeof(queryParameters.names)) queryParameters.names =
      JSON.parse('[' + queryParameters.names + ']');
